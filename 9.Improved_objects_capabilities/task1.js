...
//     console.log(Object.getOwnPropertyDescriptor(obj1, 'firstName'));
// }

function shallowMerge(a, b) {
    if (arguments.length !== 2) throw new Error('Must be 2 arguments');
    if (typeof a !== 'object' || typeof b !== 'object') throw new Error('Must be objects');
    if (a === b) throw new Error('It is the same object');
    return Object.defineProperties({...a, ...b}, { ...Object.getOwnPropertyDescriptors(a), ...Object.getOwnPropertyDescriptors(b) });
}
// Решение
