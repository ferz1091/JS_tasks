...
function CleanerRobot(initialEnergy = 0 /* Изначальный заряд батареи */) {
    if (initialEnergy < 0) throw new Error('New energy level can not be less than 0.');
    if (initialEnergy > 100) throw new Error('New energy level can not be more than 100.');
    ...
    function setEnergy(value) {
        ...
        if (value > 100) throw new Error('New energy level can not be more than 100.');
        energy = value;
    }
}
